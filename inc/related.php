      ...
      <ul class="list-film">
          <?php
            ...
            ?>
                  ...
                  <li>
                      <div class="poster">
                          <a title="<?php echo $row['tenphim'] ?> - <?php echo $row['tenkhac'] ?>" href="<?php echo $trangchu ?>/webxemphim/phim/<?php echo $row['link'] ?>">
                      ...
                      <div class="name">
                          <h4>
                              <a title="<?php echo $row['tenphim'] ?> - <?php echo $row['tenkhac'] ?>" href="<?php echo $trangchu ?>/webxemphim/phim/<?php echo $row['link'] ?>"><?php echo $row['tenphim'] ?></a>
                          </h4>
