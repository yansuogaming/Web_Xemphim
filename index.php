...
<head>
    ...
    // Nếu không có, kiểm tra ngôn ngữ trình duyệt
    if ($lang === 'en') {
    ...
    // Lưu ngôn ngữ vào cookie để dùng cho lần sau
    setcookie('lang', $lang, time() + (86400 * 30), "/"); // Cookie tồn tại 30 ngày
    ?>
    <title><?php echo ($lang == 'vi') ? 'Website đang bảo trì' : 'Website Under Maintenance'; ?></title>
...
<section id="default-card" class="default-card">
    <div class="container card">
        <h1 class="title-main">dinhtlong.com</h1>
        <p class="subheading"><?php echo ($lang == 'vi') ? 'Trang web đang bảo trì, vui lòng bạn quay lại sau....' : 'The website is under maintenance, please come back later....'; ?></p>
        <p class="subheading"></p>
        <p class="subheading"><?php echo ($lang == 'vi') ? 'Xin cảm ơn !' : 'Thank you !'; ?></p>
                ...
                <g id="OBJECTS">
                    <g>
                        ...
                        <g>
                            ...
                            <g>
                                <polygon class="st3"
                                         points="320.2,342 321.6,330 328.3,330 329.9,341.8 				"/>
                            </g>
                        </g>
                        <g>
                            <g>
...
<footer class="container">
    <div class="left-side">
		...
		c0.6-2.6,3.6-4,8.7-4c3.6,0,6.1,0.6,7.5,2c1.3,1.3,2.1,3.4,2.1,6.1L453.1,55z"/>
                        <polygon class="ssst2"
                                 points="88,52.6 88,52.6 38.4,3 24.2,17.2 59.7,52.6 24.3,88 38.4,102.2 	"/>
                        <polygon class="ssst3"
                                 points="85,49.6 85,49.6 35.4,0 21.2,14.2 56.7,49.6 21.3,85 35.4,99.2 	"/>
    ...
    <p>
        ...
        if (isset($_GET['lang']) && $_GET['lang'] == 'vi') {
            ...
            $months = array('Tháng Một', 'Tháng Hai', 'Tháng Ba', 'Tháng Tư', 'Tháng Năm', 'Tháng Sáu', 'Tháng Bảy', 'Tháng Tám', 'Tháng Chín', 'Tháng Mười', 'Tháng Mười Một', 'Tháng Mười Hai');

            $dayOfWeek = date('w');
            $month = date('n') - 1;

            echo "Khởi tạo lúc: " . $days[$dayOfWeek] . ', ngày ' . date('j') . ' ' . $months[$month] . ' năm ' . date('Y H:i:s');
        } else {
            // Ngôn ngữ mặc định (Tiếng Anh)
            echo "Created at: " . date('l, F j, Y H:i:s');
        }
        ?>
    </p>
</footer>
